        ...
        composable(Dest.CONVERSATION) { entry ->
            FeatureRouteContent(signedIn, capabilities, Dest.CONVERSATION) {
                ConversationScreen(
                    ...
                    groupPaymentRequestsEnabled = capabilities.groupPaymentRequestsReady,
                    scheduledChatPaymentsEnabled = capabilities.scheduledChatPaymentsReady,
                    scheduledGroupPaymentsEnabled = capabilities.scheduledGroupPaymentsReady,
